...
//	FA_LCDPrintString(PortNumber, 19, 8, (unsigned char *) "Liverpool Hope University");
//	FA_LCDPrintString(PortNumber, 31, 16, (unsigned char *) "Driving Test");
//
