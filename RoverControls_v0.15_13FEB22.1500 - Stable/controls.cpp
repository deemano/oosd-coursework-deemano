...
bool edgeStop = false;  // helps exchange data between Data & MovementKeys classes with minimal code
...
int DeviceOne::port(int portGiven) {
    portGiven = 3;
    int* var = &comPort;
...
jump: // Jump point
    ...
    // Handler of exception ( = Demo mode triggered)
        ...
        cout << "===========================================================================================\n";
        cout << "\nPress 'X' key to Rescan COM ports.\n\n";
        temp = 0;
        demo = true;
    }
...
int DeviceOne::autoSet_comPort() {
    Checker checker;
    DeviceOne* checkCOM = &checker; // Base class pointer referenced to an object of derived class (stored)
